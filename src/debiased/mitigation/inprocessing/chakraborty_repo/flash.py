...
from debiased.mitigation.inprocessing.chakraborty_repo.measure import calculate_recall,calculate_far,calculate_average_odds_difference, calculate_equal_opportunity_difference, get_counts, measure_final_score
...
def flash_fair_LSR(dataset_orig, biased_col, n_obj):  # biased_col can be "sex" or "race", n_obj can be "ABCD" or "AB" or "CD"
    ...
    remain_pool = set(all_case) - set(modeling_pool)
    test_list = []
