...
from debiased.mitigation.preprocessing.FAWOS.models.Label import Label
from debiased.mitigation.preprocessing.FAWOS.taxonomising.Taxonomy import Taxonomy
...
class Distribution:
    ...
    @staticmethod
    def save_distributions(labels, stats_filename: str):
        labels_strings = []
