...
from debiased.mitigation.preprocessing.FAWOS.models.FeatureType import FeatureType
...
class FeatureTypeCategorical(FeatureType):
    ...
    def encode(self,
        ...
        le = LabelEncoder()
        le.fit(feature_values_raw_train)
        ...
        return feature_values_train_series
        # , feature_values_test_series
