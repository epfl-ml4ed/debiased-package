...
class LiuInProcessor(InProcessor):
    ...
    def __init__(self, mitigating, discriminated, batch_size=128, epochs=50):
        super().__init__({'mitigating': mitigating, 'discriminated': discriminated, 'batch_size':batch_size, 'epochs': epochs})
