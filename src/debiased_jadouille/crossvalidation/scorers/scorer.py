...
class Scorer:
    ...
    def __init__(self, mitigating_attributes, discriminated,mitigating_attributes, discriminated,mitigating_attributes, discriminated,settings):
        self._name = 'scorer'
        self._notation = 'scorer'
        self._settings = dict(settings)
        self._n_classes = self._settings['pipeline']['nclasses']
    ...
    def _get_score_functions(self, settings):
        self._scorers = {}
        for score in settings['crossvalidation']['scorer']['scoring_metrics']:
