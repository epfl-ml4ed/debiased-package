...
class LiPreProcessor(PreProcessor):
    ...
    def __init__(self, mitigating, discriminated, C_factor=10, fairness_metric='dp'):
        super().__init__({'mitigating': mitigating, 'discriminated': discriminated, 'C_factor': C_factor, 'fairness_metrics':fairness_metric})
