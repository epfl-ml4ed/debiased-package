...
from debiased_jadouille.mitigation.inprocessing.gao_repo.models import Net
...
class GaoInProcessor(InProcessor):
    ...
    def __init__(self, mitigating, discriminated, batch_size=128, epochs=10, grl_lambda=50):
